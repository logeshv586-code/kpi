...
export default function Templates(){
  ...
  async function downloadTemplateSample(){try{await downloadApiFile('/admin/samples/template','KPI_Template_Import_Sample.xlsx')}catch(e){setError(getError(e))}}
