...
export default function Login(){
  const [email,setEmail]=useState('admin@eaglesoftware.in'),[password,setPassword]=useState('Admin@123'),[error,setError]=useState(''),[loading,setLoading]=useState(false),[show,setShow]=useState(false),[forgot,setForgot]=useState(false)
